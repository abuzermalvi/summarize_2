...
os.environ["GROQ_API_KEY"] = "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"
...
def get_gemini_client():
    return genai.Client(api_key=os.getenv("GEMINI_API_KEY", "AIzaSyCSGhhRfLlwVRQ6Bq4-6ngkYHtL4lx0r84"))
